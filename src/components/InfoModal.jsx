    ...
    degrees: {
      ...
      sections: [
        ...
        },
        {
          ...
          text: "Despite having 500 airports spread across the continental US, the network is incredibly well-connected. This is a real-world example of the 'small world' phenomenon – even large networks can have short paths between any two points."
        },
        {
